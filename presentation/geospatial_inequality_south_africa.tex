...
\date{18th April 2023} % \today % Date, can be changed to a custom date
...
\begin{frame}
STP3 also provides median income and GINI for 5.5km2 hexagons in cities. This shows median income in Cape Town in 2020. \\ \vspace{1mm}
...
\begin{table}[ht]
\centering
\caption{\footnotesize Correlation of Income/Wealth Measures in 5.5km2 STP3 Hexagons}
\resizebox{\textwidth}{!}{
...
\begin{frame}
Comparison of GINI Estimates 5.5km2 STP3 Hexagons \\ \vspace{1mm}
\includegraphics[width = \textwidth]{"../figures/Hex1_3km_CompGini.pdf"}
% latex table generated in R 4.1.1 by xtable 1.8-4 package
% Tue Apr 18 12:49:45 2023
\begin{table}[ht] \vspace{-4mm}
\centering
\caption{Weighted GINI Interpol. Aggregated to 5.5km2 STP3 Hexagons}
\vspace{-3mm}
\resizebox{\textwidth}{!}{
\begin{tabular}{lrrrrr}
  \toprule
